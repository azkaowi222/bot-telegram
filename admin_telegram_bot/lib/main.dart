...
import 'package:admin_telegram_bot/controllers/user_controller.dart';
...
Future<void> _firebaseMessagingBackgroundHandler(RemoteMessage message) async {
  await Firebase.initializeApp(); // Sesuaikan juga di sini (kosongkan dalam kurungnya)
...
const AndroidNotificationChannel channel = AndroidNotificationChannel(
  'high_importance_channel', // ID Channel ini yang akan kita panggil
  'Notifikasi Penting', // Nama Channel (terlihat oleh user di pengaturan HP)
  description: 'Channel ini digunakan untuk notifikasi orderan masuk.',
  importance: Importance.max, // INI YANG MEMBUATNYA JADI POPUP!
);
...
Future<void> main() async {
  ...
  // 4. Daftarkan Channel ke sistem Android saat aplikasi baru menyala
...
Future<void> _setupFCM() async {
  ...
  print(token);
  if (token != null) {
    await userController.storeToken(token);
